...
namespace PatronObserver
{
    ...
    /// </summary>
    public partial class SparrowElementViewerCtrl: UserControl, IElementoSistemaObserver
    {
        ...
        ///     visualizado.
        /// </summary>
        protected ElementoSistema sparrowElement;

        /// <summary>
        ///     El elemento del sistema de archivos actualmente 
        ///     visualizado.
        /// </summary>
        public virtual ElementoSistema SparrowElement
        {
            get
            {
            ...
            set
            {
                ...
                // Comprobamos si sparrowElement es null
                // lo eliminamos de la lista del elemento anterior y lo metemenos
                // en la nueva lista de observadores.
                if (this.sparrowElement != null)
                {
                    this.sparrowElement.EliminaObserver(this);
                }
                ...
                if (this.sparrowElement != null)
                {
                    this.sparrowElement.AnhadeObserver(this);
                }
                displayElement();
            } // set
        } // SistemaArchivo
